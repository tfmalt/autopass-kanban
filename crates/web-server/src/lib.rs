...
fn map_team_members(team: Vec<TeamMemberConfig>) -> Vec<WebTeamMember> {
...
mod tests {
    ...
    fn load_team_falls_back_to_legacy_team_file() {
        ...
        fs::write(
            temp_root.path().join(".kanban/team.json"),
            "[{\"name\":\"Legacy User\",\"email\":\"legacy@example.com\",\"avatarUrl\":\"https://example.com/avatar.png\"}]\n",
        )
        .unwrap();
